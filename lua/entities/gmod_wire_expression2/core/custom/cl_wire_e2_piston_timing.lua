...
DSC["setPistonLine(e:nn)"] = "Creates a line timed piston by "..tKey[1].." key and highest point angle in degrees"
DSC["setPistonLine(e:sn)"] = "Creates a line timed piston by "..tKey[2].." key and highest point angle in degrees"
