...
DSC["isSignPiston(e:n)"] = "Returns a flag if the piston is in sign mode by "..tKey[1].." key"
DSC["isSignPiston(e:s)"] = "Returns a flag if the piston is in sign mode by "..tKey[2].." key"
DSC["isWavePiston(e:n)"] = "Returns a flag if the piston is in wave mode by "..tKey[1].." key"
DSC["isWavePiston(e:s)"] = "Returns a flag if the piston is in wave mode by "..tKey[2].." key"
