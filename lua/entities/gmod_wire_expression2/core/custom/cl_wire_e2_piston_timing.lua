...
DSC["putPistonAxis(e:)"] = "Clears the base prop local-axis to use with the piston cross-product functions"
DSC["putPistonBase(e:e)"] = "Stores the base prop to use with the piston cross-product functions"
DSC["putPistonBase(e:)"] = "Clears the base prop to use with the piston cross-product functions"
