...
E2Helper.Descriptions["setPistonSignX(e:nvv)"] = "Creates cross product timed piston with sign output by an integer key and highest point local vector"
...
E2Helper.Descriptions["setPistonSignX(e:svv)"] = "Creates cross product timed piston with sign output by a string key and highest point local vector"
...
E2Helper.Descriptions["setPistonWaveX(e:nvv)"] = "Creates cross product timed piston with wave output by an integer key and highest point local vector"
...
E2Helper.Descriptions["setPistonWaveX(e:svv)"] = "Creates cross product timed piston with wave output by a string key and highest point local vector"
