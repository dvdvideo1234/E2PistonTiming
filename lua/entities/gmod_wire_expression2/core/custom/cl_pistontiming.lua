...
E2Helper.Descriptions["resPistonExpc()"] = "Clears the expression chip general exponential tuning coefficient using no arguments"
E2Helper.Descriptions["resPistonLogc()"] = "Clears the expression chip general logarithmic tuning coefficient using no arguments"
...
E2Helper.Descriptions["setPistonExpc(n)"] = "Stores the expression chip general exponential tuning coefficient using number"
...
E2Helper.Descriptions["setPistonLogc(n)"] = "Stores the expression chip general logarithmic tuning coefficient using number"
